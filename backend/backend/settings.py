...
SECRET_KEY = '%loojhe9%01fo&rl#o%7ooc&$02tbz#1#xmn53lpkan6$l*9r9'
...
# use: http://localhost:3000, instead of localhost:3000, otherwise:
# ERRORS:
# ?: (corsheaders.E013) Origin 'localhost:3000/' in CORS_ORIGIN_WHITELIST is missing scheme or netloc
# 	HINT: Add a scheme (e.g. https://) or netloc (e.g. example.com).

# Don't use a trailing slash ('/') at the end of the url, otherwise:
# ERRORS:
